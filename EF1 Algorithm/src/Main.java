...
public class Main {
	...
	public static void main(String[] args) {
		File data = new File("data.txt"); // file must have each agents valuations on different lines and separated by
											// commas
		...
		EF1Algo algo = new EF1Algo(); // creates algo object
		algo.allocate(agentValues); // allocates items to agents & prints them
